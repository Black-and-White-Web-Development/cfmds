...
import bannerImg from "@/assets/sections/woodwind.webp";
import { formatDate } from "@/util/formateDate";

const SECTION_ID = "l25a915jdxjiz2123yz6c9ji";
						...
						<>
							...
							{content.leader && (
								<div className="content banner__section-leader section-leader">
									...
									<p className="section-leader__contact">Contact: woodwind@cfmds.org.uk</p>
								</div>
							)}
							{content.adjudicator && (
