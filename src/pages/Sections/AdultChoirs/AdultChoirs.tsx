...
const SECTION_ID = "syqjm0drqgqw1efia92wlwba";

const AdultChoirs = function () {
						...
						<>
							...
							{content.leader && (
								<div className="content banner__section-leader section-leader">
									...
									<p className="section-leader__contact">Contact: choirs@cfmds.org.uk</p>
								</div>
							)}
							{content.adjudicator && (
